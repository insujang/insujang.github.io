...
\fancyfoot[R]{\footnotesize{Last updated: Mar 16, 2025}}
...
\section{Research Experience}
  \resumeSubHeadingListStart
    \resumeSubheading{Resource Scheduling for Multimodal LLM}{Jan 2024 -- Present}{
      \href{https://github.com/cornstarch-org/Cornstarch}{\textbf{Cornstarch}}: A distributed multimodal LLM training framework. It focuses on unique characteristics of multimodal LLMs when it is distributed across multiple GPUs.
      Exploiting the characteristics, Cornstarch introduces novel scheduling insights: for balanced end-to-end execution, you need imbalance in parallelization.
    ...
    {\href{https://github.com/SymbioticLab/Oobleck}{\textbf{Oobleck}}: An efficient fault tolerance in large scale distributed training. Oobleck introduces a groundbreaking way of fault tolerance ML; it exploits model states redundancy in data parallelism to recover lost states to avoid restart from the checkpoint, and utilizes every available GPUs by deploying heterogeneous pipeline parallel replicas. Oobleck introduces pipeline template for quick reconfiguration.}{University of Michigan}
    
    \resumeSubheading{Offloading Operations to RDMA NIC}{Jan 2020 -- Jul 2020}
    {\href{https://github.com/casys-kaist/LineFS}{\textbf{LineFS}}: Reimplemented \href{https://dl.acm.org/doi/abs/10.1145/3230543.3230572}{Hyperloop} to use it as a baseline of LineFS, which offloads replicated transaction into Infiniband RDMA adaptors.
...
\section{Work Experience}
  \resumeSubHeadingListStart
    % \resumeSubheading{Software Engineer Intern}{May 2025 -- Aug 2025}{Google LLC}{Sunnyvale, CA, USA}
...
\section{Mentoring}
  ...
  \resumeSubItem{Minkyoung Cho}{PhD Student @ UM CSE}
    \resumeSubItem{Vatsal Joshi}{MS Student @ UM CSE}
