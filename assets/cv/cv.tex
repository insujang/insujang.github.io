...
\fancyfoot[R]{\footnotesize{Last updated: June 4, 2026}}
...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  ...
  \textbf{Research Scientist at NVIDIA Research} & \href{https://insujang.github.io}{https://insujang.github.io} \\
\end{tabular*}
...
\section{Education}
  ...
  \vspace{-1pt}\item
    \begin{tabularx}{0.97\textwidth}[t]{l@{\extracolsep{\fill}}r}
      \href{https://umich.edu}{\textbf{The University of Michigan}} & \small Aug 2021 -- Jun 2026 \\ 
      \textit{\small Ph.D. in Computer Science and Engineering} & \small Ann Arbor, MI, USA \\
...
\begin{enumerate}[leftmargin=*]
  \item \small \href{https://arxiv.org/abs/2605.27918}{\textbf{Addressing Variable Heterogeneity in Distributed Multimodal Training with Entrain}} \\
  \textbf{Insu Jang}, Mosharaf Chowdhury \\
  arXiv Preprint 2026
  \item \small \href{https://arxiv.org/abs/2603.00720}{\textbf{MARS: Harmonizing Multimodal Convergence via Adaptive Rank Search}} \\
  Minkyoung Cho, \textbf{Insu Jang}, Shuowei Jin, Zesen Zhao, Adityan Jothi, Ethem F. Can, Min-Hung Chen, Z. Morley Mao \\
  arXiv Preprint 2026
  ...
  ICLR 2026
  \item \small \href{https://openreview.net/forum?id=CWisSpoJF9}{\textbf{Efficient Distributed MLLM Training with Cornstarch}} \\
...
\section{Research Experience}
  \resumeSubHeadingListStart
    \resumeSubheading{Adaptive Resource Scheduling for Distributed Multimodal LLM}{Jan 2024 -- May 2026}{
      {\textbf{Cornstarch \href{https://github.com/cornstarch-org/Cornstarch}{[source]}}}: A distributed multimodal LLM training framework. 
      It optimizes imbalance across GPUs in pipeline parallelism and context parallelism by exploiting unique characteristics of multimodal LLMs, such as frozen status and non-causal nature of multimodal attention.\newline
      \textbf{Entrain}: Multimodal LLM also introduces cross-batch variability because each modality data has its own unique distribution.
    ...
    \resumeSubheading{Offloading Distributed Transactions to RDMA NIC}{Jan 2020 -- Jul 2020}
    ...
    Studied RDMA architecture and witnessed the benefits of offloading in reducing host CPU overload.}{}

    \resumeSubheading{Architectural Support for Trusted Heterogeneous Execution}{Apr 2017 -- Oct 2018}
...
\section{Work Experience}
  ...
  \resumeSubheading{Research Scientist}{Aug 2026 --}{Architecture Research Group, NVIDIA Research}{Santa Clara, CA, USA}
  % \resumeItemListStart
  %   \resumeItem{}
  % \resumeItemListEnd
