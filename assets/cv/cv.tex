...
\fancyfoot[R]{\footnotesize{Last updated: Feb 24, 2026}}
...
\section{Research Experience}
  \resumeSubHeadingListStart
    \resumeSubheading{Adaptive Resource Scheduling for Distributed Multimodal LLM}{Jan 2024 -- Present}{
      ...
      \textbf{MANDu}: Multimodal LLM also introduces cross-batch variability because each modality data has its own unique distribution.
      MANDu introduces data-driven dynamic model parallelism and workload deferral exploiting producer-consumer pattern that breaks traditional scheduling strategy of pipeline parallelism.
    }{}
    % {\resumeSubHeadingListStart
