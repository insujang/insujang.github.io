...
\fancyfoot[R]{\footnotesize{Last updated: Aug 6, 2024}}
...
\begin{enumerate}[leftmargin=*]
  \item \small Jae-Won Chung, Yile Gu, \textbf{Insu Jang}, Luoxi Meng, Nikhil Bansal, and Mosharaf Chowdhury. \textbf{``Perseus: Reducing Energy Bloat in Large Model Training.''} \textit{ACM Symposium on Operating Systems Principles \textbf{(SOSP)}}, November 2024.
...
\section{Research Experience}
  \resumeSubHeadingListStart
    \resumeSubheading{Resource Scheduling for Multimodal LLM}{Jan 2024 -- Present}
    {Studying efficient resource scheduling for large scale multimodal large language model (MLLM).}{University of Michigan}
    \resumeSubheading{Fault Tolerant Distributed Training}{Sep 2021 -- Oct 2023}
    ...
    Oobleck has been published to SOSP'23.}{University of Michigan}
    
    \resumeSubheading{Offloading Replicated Storage Transactions to RDMA NIC}{Jan 2020 -- Jul 2020}
    ...
    Studied Infiniband RDMA architecture and witnessed the benefits of offloading in reducing host CPU overload. LineFS paper has been published to SOSP'21 and won the best paper award.}{KAIST}

    \resumeSubheading{Architectural Support for Trusted Heterogeneous Execution}{Mar 2016 -- Feb 2018}
    ...
    HIX paper has been published to ASPLOS'19.}{KAIST}
...
\section{Teaching Experience}
  \resumeSubHeadingListStart
    \resumeSubheading{Graduate Research Instructor (GSI)}{Fall 2024}
    {CSE585: Advanced Scalable Systems for Generative AI}{University of Michigan}
    % \resumeSubheading{Teaching Assistant}{University of Michigan}
    % {EECS 482: Introduction to Operating Systems}{Winter 2022}
    \resumeSubheading{Teaching Assistant}{Spring 2017}
