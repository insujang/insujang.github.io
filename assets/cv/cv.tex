...
\fancyfoot[R]{\footnotesize{Last updated: Dec 14, 2022}}
...
System Architecture, Cloud Computing, Distributed Systems, Heterogeneous Computing
...
\section{Research Experience}
  \resumeSubHeadingListStart
    ...
    {Studying an efficient system architecture for distributed ML training.
    Scrutinized Megatron-LM and DeepSpeed to understand large scale ML training.}{Sep 2021 -- Present}
    
    \resumeSubheading{Research Assistant}{KAIST}
    {Implemented Hyperloop to use it as a baseline of LineFS, which offloads replicated transaction into Infiniband adaptors.
